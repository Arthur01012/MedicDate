...
namespace MedicDate.Procesos
{
    public class clsHorarioDAL
    {
        ...
        public static bool DesactivarTodosPorDoctor(int idDoctor, MySqlTransaction? transaccion = null)// Desactiva todos los horarios de un doctor específico en la base de datos y devuelve true si la operación fue exitosa.
        {
        ...
        public static DataTable ObtenerHorariosDoctor(int idDoctor)// Obtiene todos los horarios de un doctor específico, devolviendo un DataTable con los detalles de los horarios.
        {
            string sql = @"
            SELECT 
            dia_semana AS 'Día',
